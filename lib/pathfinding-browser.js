...
// Generated by CoffeeScript 1.8.0
            (function () {
                var Heap, defaultCmp, floor, heapify, heappop, heappush, heappushpop, heapreplace, insort, min,
                    nlargest, nsmallest, updateItem, _siftdown, _siftup;
        ...
        4: [function (_dereq_, module, exports) {
            ...
            Grid.prototype.getNodeAt = function (x, y) {
                return this.nodes[this.yPos(y)][this.xPos(x)];
            };
            ...
            Grid.prototype.isWalkableAt = function (x, y) {
                return this.isInside(x, y) && this.nodes[this.yPos(y)][this.xPos(x)].walkable;
            };
            ...
            Grid.prototype.xPos = function(x){
                if (x < 0) {
                    x = this.width - 1;
            ...
            Grid.prototype.yPos = function(y){
                if (y < 0) {
                    y = this.height - 1;
            ...
            Grid.prototype.getNeighbors = function (node, diagonalMovement) {
                ...
                if (this.isWalkableAt(x, y - 1)) {
                    neighbors.push(nodes[this.yPos(y - 1)][this.xPos(x)]);
                    s0 = true;
                }
                // →
                if (this.isWalkableAt(x + 1, y)) {
                    neighbors.push(nodes[this.yPos(y)][this.xPos(x + 1)]);
                    s1 = true;
                }
                // ↓
                if (this.isWalkableAt(x, y + 1)) {
                ...
                if (d0 && this.isWalkableAt(x - 1, y - 1)) {
                    neighbors.push(nodes[this.yPos(y - 1)][this.xPos(x - 1)]);
                }
                // ↗
        ...
        7: [function (_dereq_, module, exports) {
            ...
            function distance(s, e, l) {
                return Math.min(Math.abs(s - e), Math.abs((0 - s) - (l - e)), Math.abs((l - s) - (0 - e)))
            }
                ...
                while (!openList.empty()) {
                    ...
                    for (i = 0, l = neighbors.length; i < l; ++i) {
                        ...
                        if (!neighbor.opened || ng < neighbor.g) {
                            neighbor.g = ng;
                            neighbor.h = neighbor.h || weight * heuristic(distance(x, endX, grid.width), distance(y, endY, grid.height));
            ...
            BiAStarFinder.prototype.findPath = function (startX, startY, endX, endY, grid) {
                ...
                while (!startOpenList.empty() && !endOpenList.empty()) {
                    ...
                    for (i = 0, l = neighbors.length; i < l; ++i) {
                        ...
                        if (!neighbor.opened || ng < neighbor.g) {
                            neighbor.g = ng;
                            neighbor.h = neighbor.h || weight * heuristic(distance(x, startX, grid.width), distance(y, startY, grid.height));
                            neighbor.f = neighbor.g + neighbor.h;
                            neighbor.parent = node;
        ...
        17: [function (_dereq_, module, exports) {
            ...
            IDAStarFinder.prototype.findPath = function (startX, startY, endX, endY, grid) {
                ...
                // Heuristic helper:
                var h = function (a, b) {
                    return this.heuristic(distance(b.x, a.x, grid.width), distance(b.y, a.y, grid.height));
                }.bind(this);
                ...
                for (i = 0, l = neighbors.length; i < l; ++i) {
                    ...
                    if (jumpPoint) {
                        ...
                        if (!jumpNode.opened || ng < jumpNode.g) {
                            jumpNode.g = ng;
                            jumpNode.h = jumpNode.h || heuristic(distance(jx, endX, grid.width), distance(jy, endY, grid.height));
